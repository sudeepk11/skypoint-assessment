...
const inputCls =
  'w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition-colors';
const readonlyCls =
  'w-full px-3.5 py-2.5 border border-gray-200 rounded-lg text-sm bg-gray-50 text-gray-400 cursor-not-allowed select-none';
...
const Profile: React.FC = () => {
  ...
  const content = (
    <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6">
      ...
      {/* ── profile header card ── */}
      <div className="bg-white rounded-2xl border border-gray-100 px-6 py-5 flex items-center gap-4 mb-6 shadow-sm">
        ...
        {activeTab === 'company' && user?.role === 'hr' && (
          <form onSubmit={handleSaveCompany}>
            <div className="px-6 py-5 border-b border-gray-50">
              ...
              <p className="text-xs text-gray-400 mt-0.5">Shown to candidates on your job listings.</p>
            </div>
            <div className="px-6 py-5 space-y-4">
              <div>
              ...
              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1.5 uppercase tracking-wide">Website</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1.5 uppercase tracking-wide">
                  About <span className="normal-case text-gray-400 font-normal">({companyDescription.length}/500)</span>
                </label>
                <textarea
        ...
        {activeTab === 'security' && (
          <form onSubmit={handleChangePassword}>
            <div className="px-6 py-5 border-b border-gray-50">
              ...
              <p className="text-xs text-gray-400 mt-0.5">Use a strong password with 8+ characters.</p>
            </div>
            <div className="px-6 py-5 space-y-4">
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1.5 uppercase tracking-wide">Confirm</label>
