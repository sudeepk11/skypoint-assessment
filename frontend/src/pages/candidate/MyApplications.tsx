                                ...
                                {app.resume_url && (
                                  <div>
                                    ...
                                    <a
                                      ...
                                      className="inline-flex items-center gap-2 px-3 py-2 border border-accent text-accent text-xs font-medium rounded-lg hover:bg-accent hover:text-white transition-colors"
                                    >
                                      <FileText size={13} />
